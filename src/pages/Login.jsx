...
function Login() {
  return (
    <main className="flex flex-col justify-center items-center gap-4 w-full h-screen">
      ...
      <motion.article
        className="flex flex-col items-center bg-[#ececec9d] px-5 py-6 rounded-2xl"
      ...
      >
        ...
        <span className="flex bg-[#d2d2d2] mt-5 mb-2 rounded-2xl w-75 h-[1px]"></span>

        <section className="flex flex-col justify-start w-75">
          <a
            href="#"
            className="m-0.5 text-blue-400 hover:text-blue-500 text-sm"
          >
            فراموشی رمز عبور؟
          </a>
          <a
