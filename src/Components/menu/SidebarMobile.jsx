...
function SidebarMobile() {
  ...
  return (
    <AnimatePresence>
      {menu && (
        <motion.aside
          className="740:hidden right-0 z-30 fixed flex flex-col items-center bg-amber-200 dark:bg-[#535C91] m-3 p-5 max-600:pt-12 dark:border dark:border-[#1B1A55] rounded-3xl"
