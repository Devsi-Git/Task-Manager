...
function Sidebar() {
  return (
    <aside className="max-740:hidden top-0 right-0 sticky flex flex-col justify-center items-center gap-5 p-7 1020:px-7 740:px-4 320:w-full 740:w-fit 320:h-full">
      <svg
